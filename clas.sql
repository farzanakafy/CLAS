...
(1, 'admin', 'nana123', '2025-05-09 08:41:10');
...
(1, 'aboutus', 'About Us', '<p style=\"font-size:14px; text-align:justify;\">\r\nThe Clinic Appointment System (CLAS) is a comprehensive, integrated software solution designed to streamline and automate hospital operations. Our system helps manage patient records, appointments, billing, staff schedules, ward allocation, and medical histories with precision and security. By minimizing manual processes and enhancing data accuracy, CLAS ensures improved efficiency, faster workflows, and better patient care. It supports informed decision-making and enables hospitals to deliver services in a timely, cost-effective manner while maintaining the highest standards of healthcare.\r\n</p>', NULL, NULL, '2020-05-20 01:51:52', NULL),
